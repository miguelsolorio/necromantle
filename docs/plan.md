...
- Character phase built 2026-09-05: title and character-select screens, per-class local-storage save slots with checkpoints, three new classes (Sepulcher Knight, Grave Hunter, Pale Reaver) with six abilities each, a Skills tab, class-aware loot with two legendaries per class (`character-plan.md`), and the layered horror score (`music-plan.md`).
