...
export class DebugPanel {
  ...
  constructor(private hooks: DebugHooks, private input: { wantsLock: boolean; release(): void }) {
    ...
    b('clear', () => hooks.clear()); b('+ loot', () => hooks.loot(false)); b('force legendary', () => hooks.loot(true)); b('wipe save', () => hooks.wipe()); b('next level', () => hooks.nextLevel()); b('level up', () => hooks.levelUp()); b('tp court', () => hooks.teleport('court')); b('tp door', () => hooks.teleport('door')); b('screenshot', () => hooks.screenshot());
