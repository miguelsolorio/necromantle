...
export type StatKey = 'intelligence' | 'vitality' | 'power' | 'armor' | 'critChance' | 'critDamage' | 'attackSpeed' | 'arcaneDamage' | 'fireDamage' | 'frostDamage' | 'moveSpeed' | 'energyRegen' | 'energyOnHit' | 'cooldown';
export type PowerId = 'starfall' | 'ashen' | 'fold' | 'hollowCrown' | 'cinderBand';
...
export const SLOT_LABEL: Record<Slot, string> = { weapon: 'Staff', head: 'Head', chest: 'Chest', gloves: 'Gloves', boots: 'Boots', amulet: 'Amulet', ring: 'Ring' };
...
export const AFFIX_POOL: { stat: StatKey; min: [number, number]; max: [number, number]; slots?: Slot[]; round?: number }[] = [
  ...
  { stat: 'arcaneDamage', min: [0.04, 0.08], max: [0.12, 0.25], slots: ['weapon', 'amulet', 'head'], round: 0.01 },
  { stat: 'fireDamage', min: [0.04, 0.08], max: [0.12, 0.25], slots: ['weapon', 'amulet', 'ring'], round: 0.01 },
  { stat: 'frostDamage', min: [0.04, 0.08], max: [0.12, 0.25], slots: ['weapon', 'amulet', 'ring'], round: 0.01 },
...
export const LEGENDARIES: { name: string; slot: Slot; power: PowerId; text: string }[] = [
  { name: 'Starfall Circlet', slot: 'head', power: 'starfall', text: 'Astral Orb splits into three smaller orbs after piercing four enemies.' },
  { name: 'Ashen Grimoire', slot: 'amulet', power: 'ashen', text: 'Flame Nova leaves burning ground for 6 seconds.' },
  { name: 'Boots of the Fold', slot: 'boots', power: 'fold', text: 'Rift Step gains an additional charge.' },
  { name: 'Hollow Crown', slot: 'weapon', power: 'hollowCrown', text: 'Arcane Bolt chains to a second enemy on hit.' },
  { name: 'Cinder Band', slot: 'ring', power: 'cinderBand', text: 'Burning enemies explode when they die.' },
];
