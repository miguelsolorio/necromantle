...
export class Nave extends KitLevel {
  ...
  override waves = [
    ...
    { spawns: [{ id: 'ghoul' as const, n: 12 }, { id: 'cultist' as const, n: 4 }, { id: 'fallen_knight' as const, n: 2 }] },
    { fromDoor: true, spawns: [{ id: 'ghoul' as const, n: 16 }, { id: 'wraith' as const, n: 3 }, { id: 'fallen_knight' as const, n: 2 }, { id: 'fallen_knight' as const, n: 1, elite: true }] },
  ];
